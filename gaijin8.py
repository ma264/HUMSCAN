...
from ECBAM1_blocks import ECBAM, MultiECBAM
from Multi_blocks import Multi
...
class PGMSU(nn.Module):
    def __init__(self, P, Channel, z_dim, col):
        ...
        self.multi1 = Multi(32 * P)
        # self.cbam1 = CBAM(32 * P)
        # self.cbam1 = ECBAM(3, 7)
        ...
        self.multi2 = Multi(16 * P)
        # self.cbam2 = CBAM(16*P)
        # self.cbam2 = ECBAM(3, 7)
        ...
        self.multi3 = Multi(32 * P)
        # self.cbam6 = CBAM(32 * P)
        # self.cbam6 = ECBAM(3, 7)
        ...
        self.multi4 = Multi(16 * P)
        # self.cbam7 = CBAM(16 * P)
        # self.cbam7 = ECBAM(3, 7)
        ...
        self.multi5 = Multi(4 * P)
        # self.cbam8 = CBAM(4 * P)
        # self.cbam8 = ECBAM(3, 7)
        ...
        self.multi6 = Multi(4 * P)
        # self.cbam9 = CBAM(4 * P)
        # self.cbam9 = ECBAM(3, 7)
