...
class PGMSU(nn.Module):
    def __init__(self, P, Channel, z_dim, col, patch, dim):
        ...
        self.layer15 = transformer.ViT(image_size=col, patch_size=patch, dim=(dim * z_dim), depth=2,
        ...
        self.layer10 = nn.Sequential(
            nn.Conv2d(4 * P, (dim*P)//patch**2, kernel_size=1, stride=1, padding=0),
            nn.BatchNorm2d((dim*P)//patch**2, momentum=0.5),
        )

        self.layer11 = transformer.ViT(image_size=col, patch_size=patch, dim=(dim*P), depth=2,
                                       heads=8, mlp_dim=12, pool='cls')
